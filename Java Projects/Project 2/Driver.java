...
System.out.println("Enter the desired animal name and country: ");
String name=scanner.next();
String country=scanner.next();
boolean found=false;
for(Dog d:dogList) {
if(d.getName().equalsIgnoreCase(name) && d.getAcquisitionCountry().equalsIgnoreCase(country)) {
d.setReserved(true);
found=true;
break;
}
...
if(m.getName().equalsIgnoreCase(name) && m.getAcquisitionCountry().equalsIgnoreCase(country)) {
m.setReserved(true);
found=true;
break;
}
...
if(!found)
System.out.println("No animals found in the list based on your input");
}
...
{
for(Dog d:dogList) {
if(!d.isReserved() && d.getTrainingStatus().equalsIgnoreCase("in service"))
System.out.println(d.toString());
}
for(Monkey m:monkeyList) {
if(!m.isReserved() && m.getTrainingStatus().equalsIgnoreCase("in service"))
System.out.println(m.toString());
}
}
}
